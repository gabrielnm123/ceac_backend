# Generated by Django 5.0.3 on 2024-03-20 02:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(max_length=14, validators=[django.core.validators.RegexValidator(message='O formato do CPF deve ser "XXX.XXX.XXX-XX".', regex='^\\d{3}.\\d{3}.\\d{3}-\\d{2}$')], verbose_name='CADASTRO DE PESSOA FÍSICA (CPF):')),
                ...
                ('cnpj', models.CharField(blank=True, max_length=18, null=True, validators=[django.core.validators.RegexValidator(message='O formato do CNPJ deve ser "XX.XXX.XXX/0001-XX".', regex='^\\d{2}.\\d{3}.\\d{3}/0001-\\d{2}$')], verbose_name='CNPJ:')),
